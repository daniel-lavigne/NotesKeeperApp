...
CREATE TABLE `user` (
  ...
  `RecieveAlerts` varchar(10) NOT NULL,
  PRIMARY KEY (`UserName`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

insert  into `user`(`UserName`,`FirstName`,`LastName`,`Email`,`UserPassword`,`Language`,`RecieveAlerts`) values ('abe','Abe','Aberly','abe@cprg352.com','password','eng','yes'),('admin','Admin','Admin','admin@cprg352.com','password','eng','yes'),('bob','Bob','Barker','bob@cprg352.com','password','eng','yes');
